    ...
    <div class="container mx-auto px-4 py-8 md:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row ">
            ...
            <div class="md:w-1/2 md:pr-8 ">
                ...
                <p class="mb-8 text-base text-gray-500">The Best Shopping Online Experience with Wirer </p>
                ...
                <form wire:submit.prevent="registrationStore" class="space-y-6 ">
                    ...
                    <div class="">
                        ...
                        <div class="mt-1">
                            <input id="name" type="text" wire:model.debounce.500ms="name" required
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Must be at least 12 characters in length</p>
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            <input id="password_confirmation" type="password" wire:model.debounce.500ms="password_confirmation" required
                                class="w-full rounded-md border border-gray-300 px-4 py-3 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                    ...
                    <button type="submit"
                        ...
                        <span wire:loading wire:target="registrationStore">
            ...
            <div class="hidden md:block md:w-1/2   ml-4">
