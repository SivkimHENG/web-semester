<div class="overflow-x-auto">
    ...
    <div class="mt-10 mb-5 pl-5">
        ...
        <div x-data="{ createModalOpen: false }"
            ...
            <button
                @click="$wire.resetForm(); createModalOpen = true"
                    ...
                    <div
                        ...
                        <form wire:submit.prevent="store" class="space-y-4">
                            ...
                            <div class="flex items-center space-x-2">
                                <input
                                    type="checkbox"
                                    wire:model.defer="is_out"
                                    id="create_is_out_checkbox"
                                    class="h-4 w-4">
                            ...
                            <div class="flex justify-end space-x-2">
                                ...
                                <button
                                    type="submit"
                                    @click="$wire.save().then(() => { if (!$wire.hasErrors) createModalOpen = false })"
                        ...
                        <td class="ml-2.5 text-xs">
                            <div class="inline-block">
                                <div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false"
                                    ...
                                    <button
                                        @click="$wire.edit({{ $product->id }}).then(() => modalOpen = true)"
                                    ...
                                    <template x-teleport="body">
                                        <div
                                            ...
                                            <div
                                                ...
                                                <!-- Livewire form -->
                                                <form wire:submit.prevent="{{ $selectedProductId ? 'update' : 'store' }}" class="space-y-4">
                                                    <div>
                                                        <label class="block text-sm font-medium">Name</label>
                                                        <input
                                                            type="text"
                                                    ...
                                                    <div class="flex items-center space-x-2">
                                                        <input
                                                            ...
                                                            id="is_out_checkbox"
                                                            class="h-4 w-4">
                                                        <label for="is_out_checkbox" class="text-sm">Out of Stock</label>
                                                    </div>
                                                    <div>
                                                        <label class="block text-sm font-medium">Description</label>
                                                        <textarea
                            ...
                            <div class="inline-block">
                                <div x-data="{ deleteModalOpen: false }" @keydown.escape.window="deleteModalOpen = false"
                                    class="relative">
                                    <!-- Delete Button -->
                                    <button @click="deleteModalOpen = true; $wire.selectedProductId = {{ $product->id }}"
